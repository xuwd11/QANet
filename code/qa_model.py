...
class QAModel(object):
    ...
    def build_graph(self):
        ...
        if self.FLAGS.modeling_layer == 'basic':
            ...
            blended_reps_final = tf.contrib.layers.fully_connected(blended_reps, num_outputs=self.FLAGS.hidden_size, weights_initializer=initializer_relu()) # blended_reps_final is shape (batch_size, context_len, hidden_size)
